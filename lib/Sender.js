...
function Sender(socket) {
  ...
  this._socket.on('finish', close_handler.bind(this));
  this._socket.on('end', close_handler.bind(this));
  this._socket.on('close', close_handler.bind(this));
}
...
Sender.prototype.send = function(data, options, cb) {
  ...
  var compress = options && options.deflate;
